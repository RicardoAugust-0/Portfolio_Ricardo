    ...
    >
      <div className="flex flex-col space-y-6 flex-1">
        ...
        <motion.p variants={itemVars} className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
          Estudante de Análise e Desenvolvimento de Sistemas com experiência prática em automação, extração de dados e desenvolvimento web. Conhecimentos sólidos no ecossistema JavaScript, incluindo <strong className="text-foreground">React, TailwindCSS e Node.js.</strong> Sou um profissional autodidata e busco constantemente novas soluções tecnológicas para agregar valor aos projetos em que atuo.
        </motion.p>

        <motion.div variants={itemVars} className="flex flex-wrap items-center gap-4 pt-2">
          <Button onClick={handlePrintCV} className="print:hidden shadow-lg shadow-primary/30 hover:shadow-primary/50 transition-all rounded-full px-6 h-12 text-md">
            <Download className="mr-2 h-4 w-4" />
            Baixar CV (PDF)
          </Button>
          
          <div className="flex items-center space-x-2">
            <Button variant="outline" size="icon" className="rounded-full shadow-sm hover:border-primary/50 hover:text-primary transition-all" asChild>
              <a href="https://linkedin.com/in/ricardo-augusto-344987222" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                <CustomLinkedin className="h-5 w-5" />
              </a>
            </Button>
            <Button variant="outline" size="icon" className="rounded-full shadow-sm hover:border-primary/50 hover:text-primary transition-all" asChild>
              <a href="https://github.com/RicardoAugust-0" target="_blank" rel="noreferrer" aria-label="GitHub">
